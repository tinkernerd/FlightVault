...
let sectionName = "General"; // default in case it's not updated live
...
> [[🏠 Homepage]] 
> **[[AMT Class Notes]]**
> **Book**: [[AMT Handbook - General (FAA-H-8083-30B).pdf|AMT Handbook - General (FAA-H-8083-30B)]]
> **✈️ General Classes:** `INPUT[inlineSelect(option(Fundamentals of Electricity & Electronics),option(Aircraft Drawings),option(Weight & Balance),option(Fluid Lines & Fittings),option(Aircraft Materials & Hardware & Processes),option(Ground Operations & Servicing),option(Cleaning & Corrosion Control),option(Mathematics),option(Regulations & Maintenance Forms & Records & Publications),option(Physics for Aviation),option(Inspection Concepts & Techniques),option(Human Factors)):class]`
