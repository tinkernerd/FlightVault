...
Editorial Note: For the text of SFAR No. 50-2, see [[FAR-0091|part 91 of this chapter]].
...
Editorial Note: For the text of SFAR No. 71, see [[FAR-0091|part 91 of this chapter]].
...
Editorial Note: For the text of SFAR No. 89, see [[FAR-0121|part 121 of this chapter]].
...
Editorial Note: For the text of SFAR No. 97, see [[FAR-0091|part 91 of this chapter]].
...
\(1\) The commuter or on-demand operations of each person who holds or is required to hold an Air Carrier Certificate or Operating Certificate under [[FAR-0119|part 119 of this chapter]].
...
\(4\) Each person who applies for provisional approval of an Advanced Qualification Program curriculum, curriculum segment, or portion of a curriculum segment under subpart Y of [[FAR-0121|part 121 of this chapter]] of [[FAR-0121|14 CFR part 121]] and each person employed or used by an air carrier or commercial operator under this part to perform training, qualification, or evaluation functions under an Advanced Qualification Program under subpart Y of [[FAR-0121|part 121 of this chapter]] of [[FAR-0121|14 CFR part 121]].

\(5\) Nonstop Commercial Air Tour flights conducted for compensation or hire in accordance with [[FAR-0119#§119.1   Applicability.|§119.1]](e)(2) of this chapter that begin and end at the same airport and are conducted within a 25-statute-mile radius of that airport; provided further that these operations must comply only with the drug and alcohol testing requirements in [[FAR-0120#§120.31   Prohibited drugs.|§§120.31]], 120.33, 120.35, 120.37, and 120.39 of this chapter; and with the provisions of part 136, subpart A, and [[FAR-0091#§91.147   Passenger carrying flights for compensation or hire.|§91.147]] of this chapter by September 11, 2007.
...
\(9\) Helicopter air ambulance operations as defined in [[FAR-0135#§135.601   Applicability and definitions.|§135.601]](b)(1).

\(b\) \[Reserved\]

\(c\) An operator who does not hold a part 119 certificate and who operates under the provisions of [[FAR-0091#§91.147   Passenger carrying flights for compensation or hire.|§91.147]] of this chapter is permitted to use a person who is otherwise authorized to perform aircraft maintenance or preventive maintenance duties and who is not subject to anti-drug and alcohol misuse prevent programs to perform—
...
Editorial Note: For Federal Register citations affecting [[FAR-0135#§135.1   Applicability.|§135.1]], see the List of CFR Sections Affected, which appears in the Finding Aids section of the printed volume and at *www.govinfo.gov.*



### §135.2   Compliance schedule for operators that transition to [[FAR-0121|part 121 of this chapter]]; certain new entrant operators.

\(a\) *Applicability.* This section applies to the following:

\(1\) Each certificate holder that was issued an air carrier or operating certificate and operations specifications under the requirements of [[FAR-0135|part 135 of this chapter]] or under SFAR No. 38-2 of [[FAR-0121|14 CFR part 121]] before January 19, 1996, and that conducts scheduled passenger-carrying operations with:
...
\(b\) *Obtaining operations specifications.* A certificate holder described in paragraph (a)(1) of this section may not, after March 20, 1997, operate an airplane described in paragraphs (a)(1)(i), (a)(1)(ii), or (a)(1)(iii) of this section in scheduled passenger-carrying operations, unless it obtains operations specifications to conduct its scheduled operations under [[FAR-0121|part 121 of this chapter]] on or before March 20, 1997.

\(c\) *Regular or accelerated compliance.* Except as provided in paragraphs (d), and (e) of this section, each certificate holder described in paragraph (a)(1) of this section shall comply with each applicable requirement of [[FAR-0121|part 121 of this chapter]] on and after March 20, 1997 or on and after the date on which the certificate holder is issued operations specifications under this part, whichever occurs first. Except as provided in paragraphs (d) and (e) of this section, each person described in paragraph (a)(2) of this section shall comply with each applicable requirement of [[FAR-0121|part 121 of this chapter]] on and after the date on which that person is issued a certificate and operations specifications under [[FAR-0121|part 121 of this chapter]].

\(d\) *Delayed compliance dates.* Unless paragraph (e) of this section specifies an earlier compliance date, no certificate holder that is covered by paragraph (a) of this section may operate an airplane in [[FAR-0121|14 CFR part 121]] operations on or after a date listed in this paragraph unless that airplane meets the applicable requirement of this paragraph:
...
\(A\) For airplanes described in [[FAR-0121#§121.157   Aircraft certification and equipment requirements.|§121.157]](f), the Airplane Performance Operating Limitations in [[FAR-0121#§121.189   Airplanes: Turbine engine powered: Takeoff limitations.|§§121.189]] through 121.197.
...
\(e\) *Newly manufactured airplanes.* No certificate holder that is described in paragraph (a) of this section may operate under [[FAR-0121|part 121 of this chapter]] an airplane manufactured on or after a date listed in this paragraph (e) unless that airplane meets the applicable requirement listed in this paragraph (e).
...
\(f\) *New type certification requirements.* No person may operate an airplane for which the application for a type certificate was filed after March 29, 1995, in [[FAR-0121|14 CFR part 121]] operations unless that airplane is type certificated under [[FAR-0025|part 25 of this chapter]].

\(g\) *Transition plan.* Before March 19, 1996 each certificate holder described in paragraph (a)(1) of this section must submit to the FAA a transition plan (containing a calendar of events) for moving from conducting its scheduled operations under the commuter requirements of [[FAR-0135|part 135 of this chapter]] to the requirements for domestic or flag operations under [[FAR-0121|part 121 of this chapter]]. Each transition plan must contain details on the following:

\(1\) Plans for obtaining new operations specifications authorizing domestic or flag operations;

\(2\) Plans for being in compliance with the applicable requirements of [[FAR-0121|part 121 of this chapter]] on or before March 20, 1997; and
...
\(2\) *Initial and recurrent leadership and command and mentoring training.* Certificate holders are not required to include leadership and command training in [[FAR-0121#§121.409   Training courses using flight simulation training devices.|§§121.409]](b)(2)(ii)(B)(*6*), 121.419(c)(1), 121.424(b) and 121.427(d)(1) of this chapter and mentoring training in [[FAR-0121#§121.419   Pilots and flight engineers: Initial, transition, conversion and upgrade ground training.|§§121.419]](c)(2) and 121.427(d)(1) of this chapter in initial and recurrent training for pilots in command who serve in operations that use only one pilot.
...
\(2\) *Flight crew experience.* The crewmembers must have met the applicable requirements of [[FAR-0061|part 61 of this chapter]] and have the following experience and ratings:
...
\(i\) Landings at the destination airport when a Destination Airport Analysis is required by [[FAR-0135#§135.385   Large transport category airplanes: Turbine engine powered: Landing limitations: Destination airports.|§135.385]](f); and
...
\(c\) An eligible on-demand operation may comply with alternative requirements specified in [[FAR-0135#§135.225   IFR: Takeoff, approach and landing minimums.|§§135.225]](b), 135.385(f), and 135.387(b) instead of the requirements that apply to other on-demand operations.
...
The rules in this part which apply to a person certificated under [[FAR-0119|part 119 of this chapter]] also apply to a person who engages in any operation governed by this part without an appropriate certificate and operations specifications required by [[FAR-0119|part 119 of this chapter]].
...
A certificate holder may use a crewmember who received the certificate holder's training in accordance with subparts E, G, and H of this part before March 19, 1997 without complying with initial training and qualification requirements of subparts N and O of [[FAR-0121|part 121 of this chapter]]. The crewmember must comply with the applicable recurrent training requirements of [[FAR-0121|part 121 of this chapter]].
...
\(a\) The name of each management person required under [[FAR-0119#§119.69 Management personnel required for operations conducted under 0135 Operating requirements commuter and on demand operations and rules governing persons on board such aircraft part 135 of this chapter .|§119.69]] (a) of this chapter who is authorized to act for the certificate holder, the person's assigned area of responsibility, the person's duties, responsibilities, and authority, and the name and title of each person authorized to exercise operational control under [[FAR-0135#§135.77   Responsibility for operational control.|§135.77]];

\(b\) Procedures for ensuring compliance with aircraft weight and balance limitations and, for multiengine aircraft, for determining compliance with [[FAR-0135#§135.185   Empty weight and center of gravity: Currency requirement.|§135.185]];
...
\(i\) Procedures under [[FAR-0135#§135.179   Inoperable instruments and equipment.|§135.179]] for the release for, or continuation of, flight if any item of equipment required for the particular type of operation becomes inoperative or unserviceable en route;
...
\(k\) Procedures to be followed by the pilot in command in the briefing under [[FAR-0135#§135.117   Briefing of passengers before flight.|§135.117]];

\(l\) Flight locating procedures, when applicable;

\(m\) Procedures for ensuring compliance with emergency procedures, including a list of the functions assigned each category of required crewmembers in connection with an emergency and emergency evacuation duties under [[FAR-0135#§135.123   Emergency and emergency evacuation duties.|§135.123]];
...
\(r\) If required by [[FAR-0135#§135.385   Large transport category airplanes: Turbine engine powered: Landing limitations: Destination airports.|§135.385]], an approved Destination Airport Analysis establishing runway safety margins at destination airports, taking into account the following factors as supported by published aircraft performance data supplied by the aircraft manufacturer for the appropriate runway conditions—
...
If the holder of a certificate operating under this part allows any aircraft owned or leased by that holder to be engaged in any operation that the certificate holder knows to be in violation of [[FAR-0091#§91.19   Carriage of narcotic drugs, marihuana, and depressant or stimulant drugs or substances.|§91.19]](a) of this chapter, that operation is a basis for suspending or revoking the certificate.
...
This subpart prescribes rules, in addition to those in [[FAR-0091|part 91 of this chapter]], that apply to operations under this part.
...
\(5\) An individual record for each flight attendant who is required under this part, maintained in sufficient detail to determine compliance with the applicable portions of [[FAR-0135#§135.273   Duty period limitations and rest time requirements.|§135.273]] of this part.
...
\(d\) Each certificate holder shall establish a procedure for keeping copies of the aircraft maintenance log required by this section in the aircraft for access by appropriate personnel and shall include that procedure in the manual required by [[FAR-0135#§135.21   Manual requirements.|§135.21]].
...
Each certificate holder is responsible for operational control and shall list, in the manual required by [[FAR-0135#§135.21   Manual requirements.|§135.21]], the name and title of each person authorized by it to exercise operational control.
...
\(b\) This part and [[FAR-0091|part 91 of this chapter]].
...
\(5\) For multiengine aircraft, one-engine-inoperative climb performance data and if the aircraft is approved for use in IFR or over-the-top operations, that data must be sufficient to enable the pilot to determine compliance with [[FAR-0135#§135.181   Performance requirements: Aircraft operated over-the-top or in IFR conditions.|§135.181]](a)(2).
...
\(A\) Reported weather conditions are less than the basic VFR weather conditions in [[FAR-0091#§91.155   Basic VFR weather minimums.|§91.155]] of this chapter;

\(B\) Suitable visual references specified in [[FAR-0091#§91.175   Takeoff and landing under IFR.|§91.175]] of this chapter have been established on the instrument approach procedure; and
...
\(A\) Reported weather conditions are equal to or better than the basic VFR weather conditions in [[FAR-0091#§91.155   Basic VFR weather minimums.|§91.155]] of this chapter; and
...
\(c\) Except as provided in paragraph (d) of this section, a certificate holder authorized to conduct operations under instrument flight rules may receive authorization from the Administrator through its operations specifications to establish a second-in-command professional development program. As part of that program, a pilot employed by the certificate holder may log time as second in command in operations conducted under this part and [[FAR-0091|part 91 of this chapter]] that do not require a second pilot by type certification of the aircraft or the regulation under which the flight is being conducted, provided the flight operation is conducted in accordance with the certificate holder's operations specifications for second-in-command professional development program; and—

\(1\) The certificate holder:

\(i\) Maintains records for each assigned second in command consistent with the requirements in [[FAR-0135#§135.63   Recordkeeping requirements.|§135.63]];

\(ii\) Provides a copy of the records required by [[FAR-0135#§135.63   Recordkeeping requirements.|§135.63]](a)(4)(vi) and (x) to the assigned second in command upon request and within a reasonable time; and
...
\(i\) The second in command qualifications in [[FAR-0135#§135.245   Second in command qualifications.|§135.245]];
...
\(2\) A certificate holder that has been approved to deviate from the requirements in [[FAR-0135#§135.21   Manual requirements.|§135.21]](a), [[FAR-0135#§135.341   Pilot and flight attendant crewmember training programs.|§135.341]](a), or 
[[FAR-0119#§119.69 Management personnel required for operations conducted under 0135 Operating requirements commuter and on demand operations and rules governing persons on board such aircraft part 135 of this chapter .|part 135 of this chapter]]Management personnel required for operations conducted under [[FAR-0135|part 135 of this chapter]].|§119.69]] (a) of this chapter.
...
Except as provided in [[FAR-0135#§135.105   Exception to second in command requirement: Approval for use of autopilot system.|§135.105]], no person may operate an aircraft carrying passengers under IFR unless there is a second in command in the aircraft.
...
\(a\) Except as provided in [[FAR-0135#§135.99   Composition of flight crew.|§§135.99]] and 135.111, unless two pilots are required by this chapter for operations under VFR, a person may operate an aircraft without a second in command, if it is equipped with an operative approved autopilot system and the use of that system is authorized by appropriate operations specifications. No certificate holder may use any person, nor may any person serve, as a pilot in command under this section of an aircraft operated in a commuter operation, as defined in [[FAR-0119|part 119 of this chapter]] unless that person has at least 100 hours pilot in command flight time in the make and model of aircraft to be flown and has met all other applicable requirements of this part.
...
\(9\) If a rotorcraft operation involves flight beyond autorotational distance from the shoreline, as defined in [[FAR-0135#§135.168   Emergency equipment: Overwater rotorcraft operations.|§135.168]](a), use of life preservers, ditching procedures and emergency exit from the rotorcraft in the event of a ditching; and the location and use of life rafts and other life preserver devices if applicable.
...
\(b\) The certificate holder shall describe in the manual required under [[FAR-0135#§135.21   Manual requirements.|§135.21]] the functions of each category of required crewmembers assigned under paragraph (a) of this section.
...
(*4*) That the seat or child restraint device furnished by the certificate holder, or one of the persons described in paragraph (a)(2)(i) of this section, was approved by the FAA in accordance with [[FAR-0021#§21.8   Approval of articles.|§21.8]](d) of this chapter or Technical Standard Order C-100b, or a later version. The child restraint device manufactured by AmSafe, Inc. (CARES, Part No. 4082) and approved by the FAA in accordance with [[FAR-0021#§21.305   Organization.|§21.305]](d) (2010 ed.) of this chapter may continue to bear a label or markings showing FAA approval in accordance with [[FAR-0021#§21.305   Organization.|§21.305]](d) (2010 ed.) of this chapter.

\(D\) Except as provided in [[FAR-0135#§135.128   Use of safety belts and child restraint systems.|§135.128]](a)(2)(ii)(C)(*3*) and [[FAR-0135#§135.128   Use of safety belts and child restraint systems.|§135.128]](a)(2)(ii)(C)(*4*), booster-type child restraint systems (as defined in Federal Motor Vehicle Safety Standard No. 213 (49 CFR 571.213)), vest- and harness-type child restraint systems, and lap held child restraints are not approved for use in aircraft; and
...
\(b\) Except as provided in [[FAR-0135#§135.179   Inoperable instruments and equipment.|§135.179]], no person may operate an aircraft under this part unless the required instruments and equipment in it have been approved and are in an operable condition.
...
\(5\) Portable oxygen concentrators that comply with the requirements in [[FAR-0135#§135.91   Oxygen and portable oxygen concentrators for medical use by passengers.|§135.91]]; or
...
\(2\) Is approved in accordance with [[FAR-0021#§21.305   Organization.|§21.305]] of this chapter;
...
\(7\) For transport category airplanes manufactured on or after November 27, 1990, meets the requirements of [[FAR-0025#§25.1423   Public address system.|§25.1423]] of this chapter.
...
\(1\) Is installed in accordance with the requirements of [[FAR-0023#§23.1457   Cockpit voice recorders.|§23.1457]] (except paragraphs (a)(6), (d)(1)(ii), (4), and (5)); [[FAR-0025#§25.1457   Cockpit voice recorders.|§25.1457]] (except paragraphs (a)(6), (d)(1)(ii), (4), and (5)); [[FAR-0027#§27.1457   Cockpit voice recorders.|§27.1457]] (except paragraphs (a)(6), (d)(1)(ii), (4), and (5)); or [[FAR-0029#§29.1457   Cockpit voice recorders.|§29.1457]] (except paragraphs (a)(6), (d)(1)(ii), (4), and (5)) of this chapter, as applicable; and
...
\(f\) By April 7, 2012, all airplanes subject to paragraph (a) or paragraph (b) of this section that are manufactured before April 7, 2010, and that are required to have a flight data recorder installed in accordance with [[FAR-0135#§135.152   Flight data recorders.|§135.152]], must have a cockpit voice recorder that also—

\(1\) Meets the requirements in [[FAR-0023#§23.1457   Cockpit voice recorders.|§23.1457]](d)(6) or [[FAR-0025#§25.1457   Cockpit voice recorders.|§25.1457]](d)(6) of this chapter, as applicable; and

\(2\) If transport category, meet the requirements in [[FAR-0025#§25.1457   Cockpit voice recorders.|§25.1457]](a)(3), (a)(4), and (a)(5) of this chapter.

(g)(1) No person may operate a multiengine, turbine-powered airplane or rotorcraft that is manufactured on or after April 7, 2010, that has a passenger seating configuration of six or more seats, for which two pilots are required by certification or operating rules, and that is required to have a flight data recorder under [[FAR-0135#§135.152   Flight data recorders.|§135.152]], unless it is equipped with an approved cockpit voice recorder that also—

\(i\) Is installed in accordance with the requirements of [[FAR-0023#§23.1457   Cockpit voice recorders.|§23.1457]] (except for paragraph (a)(6)); [[FAR-0025#§25.1457   Cockpit voice recorders.|§25.1457]] (except for paragraph (a)(6)); [[FAR-0027#§27.1457   Cockpit voice recorders.|§27.1457]] (except for paragraph (a)(6)); or [[FAR-0029#§29.1457   Cockpit voice recorders.|§29.1457]] (except for paragraph (a)(6)) of this chapter, as applicable; and
...
\(iv\) For all airplanes or rotorcraft manufactured on or after December 6, 2010, also meets the requirements of [[FAR-0023#§23.1457   Cockpit voice recorders.|§23.1457]](a)(6); [[FAR-0025#§25.1457   Cockpit voice recorders.|§25.1457]](a)(6); [[FAR-0027#§27.1457   Cockpit voice recorders.|§27.1457]](a)(6); or §29.457(a)(6) of this chapter, as applicable.

\(2\) No person may operate a multiengine, turbine-powered airplane or rotorcraft that is manufactured on or after April 7, 2010, has a passenger seating configuration of 20 or more seats, and that is required to have a flight data recorder under [[FAR-0135#§135.152   Flight data recorders.|§135.152]], unless it is equipped with an approved cockpit voice recorder that also—
...
(f)(1) For airplanes manufactured on or before August 18, 2000, and all other aircraft, each flight recorder required by this section must be installed in accordance with the requirements of [[FAR-0023#§23.1459   Flight data recorders.|§23.1459]] (except paragraphs (a)(3)(ii) and (6)), [[FAR-0025#§25.1459   Flight data recorders.|§25.1459]] (except paragraphs (a)(3)(ii) and (7)), [[FAR-0027#§27.1459   Flight data recorders.|§27.1459]] (except paragraphs (a)(3)(ii) and (6)), or [[FAR-0029#§29.1459   Flight data recorders.|§29.1459]] (except paragraphs (a)(3)(ii) and (6)), as appropriate, of this chapter. The correlation required by paragraph (c) of [[FAR-0023#§23.1459   Flight data recorders.|§§23.1459]], 25.1459, 27.1459, or 29.1459 of this chapter, as appropriate, need be established only on one aircraft of a group of aircraft:
...
\(l\) By April 7, 2012, all aircraft manufactured before April 7, 2010, must also meet the requirements in [[FAR-0023#§23.1459   Flight data recorders.|§23.1459]](a)(7), [[FAR-0025#§25.1459   Flight data recorders.|§25.1459]](a)(8), [[FAR-0027#§27.1459   Flight data recorders.|§27.1459]](e), or [[FAR-0029#§29.1459   Flight data recorders.|§29.1459]](e) of this chapter, as applicable.

\(m\) All aircraft manufactured on or after April 7, 2010, must have a flight data recorder installed that also—

\(1\) Meets the requirements of [[FAR-0023#§23.1459   Flight data recorders.|§23.1459]](a)(3), (a)(6), and (a)(7), [[FAR-0025#§25.1459   Flight data recorders.|§25.1459]](a)(3), (a)(7), and (a)(8), [[FAR-0027#§27.1459   Flight data recorders.|§27.1459]](a)(3), (a)(6), and (e), or [[FAR-0029#§29.1459   Flight data recorders.|§29.1459]](a)(3), (a)(6), and (e) of this chapter, as applicable; and
...
\(b\) An original sensor signal for any flight recorder parameter required to be recorded under [[FAR-0135#§135.152   Flight data recorders.|§135.152]] may be filtered only if the recorded signal value continues to meet the requirements of Appendix D or F of this part, as applicable.

\(c\) For a parameter described in [[FAR-0135#§135.152   Flight data recorders.|§135.152]](h)(12) through (17), (42), or (88), or the corresponding parameter in Appendix D of this part, if the recorded signal value is filtered and does not meet the requirements of Appendix D or F of this part, as applicable, the certificate holder must:
...
\(ii\) The certificate holder maintains documentation of the procedure required to reconstruct the original sensor signal value. This documentation is also subject to the requirements of [[FAR-0135#§135.152   Flight data recorders.|§135.152]](e).

\(d\) *Compliance.* Compliance is required as follows:

\(1\) No later than October 20, 2011, each operator must determine, for each aircraft on its operations specifications, whether the aircraft's DFDR system is filtering any of the parameters listed in paragraph (c) of this section. The operator must create a record of this determination for each aircraft it operates, and maintain it as part of the correlation documentation required by [[FAR-0135#§135.152   Flight data recorders.|§135.152]] (f)(1)(iii) or (f)(2)(iii) of this part as applicable.
...
\(4\) After April 21, 2014, no aircraft flight data recording system may filter any parameter listed in paragraph (c) of this section that does not meet the requirements of Appendix D or F of this part, unless the certificate holder possesses test and analysis procedures and the test results that have been approved by the FAA. All records of tests, analysis and procedures used to comply with this section must be maintained as part of the correlation documentation required by [[FAR-0135#§135.152   Flight data recorders.|§135.152]] (f)(1)(iii) or (f)(2)(iii) of this part as applicable.

\[Doc. No. FAA-2006-26135, 75 FR 7357, Feb. 19, 2010\]

### §135.157   Oxygen equipment requirements.

\(a\) *Unpressurized aircraft.* No person may operate an unpressurized aircraft at altitudes prescribed in this section unless it is equipped with enough oxygen dispensers and oxygen to supply the pilots under [[FAR-0135#§135.89   Pilot requirements: Use of oxygen.|§135.89]](a) and to supply, when flying—
...
\(2\) Unless it is equipped with enough oxygen dispensers and oxygen to comply with paragraph (a) of this section whenever the cabin pressure altitude exceeds 10,000 feet MSL and, if the cabin pressurization fails, to comply with [[FAR-0135#§135.89   Pilot requirements: Use of oxygen.|§135.89]] (a) or to provide a 2-hour supply for each pilot, whichever is greater, and to supply when flying—
...
\(1\) Airplanes with a third attitude instrument system usable through flight attitudes of 360 degrees of pitch-and-roll and installed in accordance with the instrument requirements prescribed in [[FAR-0121#§121.305   Flight and navigational equipment.|§121.305]](j) of this chapter.

\(2\) Helicopters with a third attitude instrument system usable through flight attitudes of ±80 degrees of pitch and ±120 degrees of roll and installed in accordance with [[FAR-0029#§29.1303   Flight and navigation instruments.|§29.1303]](g) of this chapter.
...
\(d\) *Airplane communication equipment requirements.* Except as permitted in paragraph (e) of this section, no person may operate a turbojet airplane having a passenger seat configuration, excluding any pilot seat, of 10 seats or more, or a multiengine airplane in a commuter operation, as defined in [[FAR-0119|part 119 of this chapter]], under IFR or in extended over-water operations unless the airplane is equipped with—

\(1\) At least two independent communication systems necessary under normal operating conditions to fulfill the functions specified in [[FAR-0121#§121.347   Communication and navigation equipment for operations under VFR over routes navigated by pilotage.|§121.347]](a) of this chapter; and
...
\(1\) An approved life preserver equipped with an approved survivor locator light for each occupant of the rotorcraft. The life preserver must be worn by each occupant while the rotorcraft is beyond autorotational distance from the shoreline, except for a patient transported during a helicopter air ambulance operation, as defined in [[FAR-0135#§135.601   Applicability and definitions.|§135.601]](b)(1), when wearing a life preserver would be inadvisable for medical reasons; and
...
\(e\) *ELT alternative compliance.* Operators with an ELT required by paragraph (b)(2) of this section, or an ELT with an approved deviation under [[FAR-0021#§21.618   Approval for deviation.|§21.618]] of this chapter, are in compliance with this section.
...
\(a\) Except for commuter category airplanes, no person may operate a large airplane unless it meets the additional airworthiness requirements of [[FAR-0121#§121.213   \[Reserved\]|§§121.213]] through 121.283 and 121.307 of this chapter.
...
\(8\) In the normal category, as a multi-engine certification level 4 airplane as defined in [[FAR-0023|part 23 of this chapter]].
...
\(1\) After March 20, 1991, each Class C or D compartment, as defined in [[FAR-0025#§25.857   Cargo compartment classification.|§25.857]] of [[FAR-0025|part 25 of this chapter]], greater than 200 cubic feet in volume in a transport category airplane type certificated after January 1, 1958, must have ceiling and sidewall panels which are constructed of:
...
\(a\) No person may operate an airplane that conforms to an amended or supplemental type certificate issued in accordance with SFAR No. 41 for a maximum certificated takeoff weight in excess of 12,500 pounds unless within one year after issuance of the initial airworthiness certificate under that SFAR, the airplane meets the compartment interior requirements set forth in [[FAR-0025#§25.853   Compartment interiors.|§25.853]](a) in effect March 6, 1995 (formerly [[FAR-0025#§25.853   Compartment interiors.|§25.853]] (a), (b), (b-1), (b-2), and (b-3) of this chapter in effect on September 26, 1978).
...
\(1\) Except for those materials covered by paragraph (b)(2) of this section, all materials in each compartment used by the crewmembers or passengers must meet the requirements of [[FAR-0025#§25.853   Compartment interiors.|§25.853]] of this chapter in effect as follows or later amendment thereto:

\(i\) Except as provided in paragraph (b)(1)(iv) of this section, each airplane with a passenger capacity of 20 or more and manufactured after August 19, 1988, but prior to August 20, 1990, must comply with the heat release rate testing provisions of [[FAR-0025#§25.853   Compartment interiors.|§25.853]](d) in effect March 6, 1995 (formerly [[FAR-0025#§25.853   Compartment interiors.|§25.853]](a-1) in effect on August 20, 1986), except that the total heat release over the first 2 minutes of sample exposure rate must not exceed 100 kilowatt minutes per square meter and the peak heat release rate must not exceed 100 kilowatts per square meter.

\(ii\) Each airplane with a passenger capacity of 20 or more and manufactured after August 19, 1990, must comply with the heat release rate and smoke testing provisions of [[FAR-0025#§25.853   Compartment interiors.|§25.853]](d) in effect March 6, 1995 (formerly [[FAR-0025#§25.831   Ventilation.|§25.83]](a-1) in effect on September 26, 1988).

\(iii\) Except as provided in paragraph (b)(1) (v) or (vi) of this section, each airplane for which the application for type certificate was filed prior to May 1, 1972, must comply with the provisions of [[FAR-0025#§25.853   Compartment interiors.|§25.853]] in effect on April 30, 1972, regardless of the passenger capacity, if there is a substantially complete replacement of the cabin interior after April 30, 1972.
...
\(v\) Except as provided in paragraph (b)(1)(vi) of this section, each airplane that was type certificated after January 1, 1958, must comply with the heat release testing provisions of [[FAR-0025#§25.853   Compartment interiors.|§25.853]](d) in effect March 6, 1995 (formerly [[FAR-0025#§25.853   Compartment interiors.|§25.853]](a-1) in effect on August 20, 1986), if there is a substantially complete replacement of the cabin interior components identified in that paragraph on or after that date, except that the total heat release over the first 2 minutes of sample exposure shall not exceed 100 kilowatt-minutes per square meter and the peak heat release rate shall not exceed 100 kilowatts per square meter.

\(vi\) Each airplane that was type certificated after January 1, 1958, must comply with the heat release rate and smoke testing provisions of [[FAR-0025#§25.853   Compartment interiors.|§25.853]](d) in effect March 6, 1995 (formerly [[FAR-0025#§25.853   Compartment interiors.|§25.853]](a-1) in effect on August 20, 1986), if there is a substantially complete replacement of the cabin interior components identified in that paragraph after August 19, 1990.

\(vii\) Contrary provisions of this section notwithstanding, the Director of the division of the Aircraft Certification Service responsible for the airworthiness rules may authorize deviation from the requirements of paragraph (b)(1)(i), (b)(1)(ii), (b)(1)(v), or (b)(1)(vi) of this section for specific components of the cabin interior that do not meet applicable flammability and smoke emission requirements, if the determination is made that special circumstances exist that make compliance impractical. Such grants of deviation will be limited to those airplanes manufactured within 1 year after the applicable date specified in this section and those airplanes in which the interior is replaced within 1 year of that date. A request for such grant of deviation must include a thorough and accurate analysis of each component subject to [[FAR-0025#§25.853   Compartment interiors.|§25.853]](d) in effect March 6, 1995 (formerly [[FAR-0025#§25.853   Compartment interiors.|§25.853]](a-1) in effect on August 20, 1986), the steps being taken to achieve compliance, and, for the few components for which timely compliance will not be achieved, credible reasons for such noncompliance.

\(viii\) Contrary provisions of this section notwithstanding, galley carts and standard galley containers that do not meet the flammability and smoke emission requirements of [[FAR-0025#§25.853   Compartment interiors.|§25.853]](d) in effect March 6, 1995 (formerly [[FAR-0025#§25.853   Compartment interiors.|§25.853]](a-1) in effect on August 20, 1986), may be used in airplanes that must meet the requirements of paragraph (b)(1)(i), (b)(1)(ii), (b)(1)(iv) or (b)(1)(vi) of this section provided the galley carts or standard containers were manufactured prior to March 6, 1995.

\(2\) For airplanes type certificated after January 1, 1958, seat cushions, except those on flight crewmember seats, in any compartment occupied by crew or passengers must comply with the requirements pertaining to fire protection of seat cushions in [[FAR-0025#§25.853   Compartment interiors.|§25.853]](c) effective November 26, 1984.
...
\(d\) If the airborne thunderstorm detection equipment becomes inoperative en route, the aircraft must be operated under the instructions and procedures specified for that event in the manual required by [[FAR-0135#§135.21   Manual requirements.|§135.21]].
...
\(c\) If the airborne weather radar equipment becomes inoperative en route, the aircraft must be operated under the instructions and procedures specified for that event in the manual required by [[FAR-0135#§135.21   Manual requirements.|§135.21]].
...
\(3\) For airplanes type certificated after January 1, 1958, include floor proximity emergency escape path marking which meets the requirements of [[FAR-0025#§25.812   Emergency lighting.|§25.812]](e) of this chapter in effect on November 26, 1984.

\(d\) *Emergency light operation.* Except for lights forming part of emergency lighting subsystems provided in compliance with [[FAR-0025#§25.812   Emergency lighting.|§25.812]](h) of this chapter (as prescribed in paragraph (h) of this section) that serve no more than one assist means, are independent of the airplane's main emergency lighting systems, and are automatically activated when the assist means is deployed, each light required by paragraphs (c) and (h) of this section must:
...
\(3\) There must be access from the main aisle to each Type III and Type IV exit. The access from the aisle to these exits must not be obstructed by seats, berths, or other protrusions in a manner that would reduce the effectiveness of the exit. In addition, for a transport category airplane type certificated after January 1, 1958, there must be placards installed in accordance with [[FAR-0025#§25.813   Emergency exit access.|§25.813]](c)(3) of this chapter for each Type III exit after December 3, 1992.
...
\(6\) If it is necessary to pass through a doorway separating the passenger cabin from other areas to reach a required emergency exit from any passenger seat, the door must have a means to latch it in the open position, and the door must be latched open during each takeoff and landing. The latching means must be able to withstand the loads imposed upon it when the door is subjected to the ultimate inertia forces, relative to the surrounding structure, listed in [[FAR-0025#§25.561   General.|§25.561]](b) of this chapter.
...
\(i\) For an airplane for which the application for the type certificate was filed prior to May 1, 1972, the requirements of [[FAR-0025#§25.812   Emergency lighting.|§25.812]] (f) and (g) of this chapter in effect on April 30, 1972.
...
\(i\) For an airplane for which the application for the type certificate was filed prior to May 1, 1972, the requirements of [[FAR-0025#§25.803   Emergency evacuation.|§25.803]](e) of this chapter in effect on April 30, 1972.
...
\(b\) The airplane flight manual required by [[FAR-0135#§135.21   Manual requirements.|§135.21]] of this part shall contain the following information on the TCAS I system required by this section:
...
Subject to any additional limitations in [[FAR-0135#§135.181   Performance requirements: Aircraft operated over-the-top or in IFR conditions.|§135.181]], no person may operate an aircraft under VFR over-the-top carrying passengers, unless—
...
\(2\) Allows an IFR approach and landing with flight clear of the clouds until reaching the prescribed initial approach altitude over the final approach facility, unless the approach is made with the use of radar under [[FAR-0091#§91.175   Takeoff and landing under IFR.|§91.175]](i) of this chapter; or
...
\(g\) If takeoff minimums are specified in [[FAR-0097|part 97 of this chapter]] for the take- off airport, no pilot may take off an aircraft under IFR when the weather conditions reported by the facility described in paragraph (a)(1) of this section are less than the takeoff minimums specified for the takeoff airport in part 97 or in the certificate holder's operations specifications.

\(h\) Except as provided in paragraph (i) of this section, if takeoff minimums are not prescribed in [[FAR-0097|part 97 of this chapter]] for the takeoff airport, no pilot may takeoff an aircraft under IFR when the weather conditions reported by the facility described in paragraph (a)(1) of this section are less than that prescribed in [[FAR-0091|part 91 of this chapter]] or in the certificate holder's operations specifications.
...
\(j\) A pilot may begin an instrument approach procedure, or continue an approach, at an airport when the visibility is reported to be less than the visibility minimums prescribed for that procedure if the pilot uses an operable EFVS in accordance with [[FAR-0091#§91.176   Straight-in landing operations below DA/DH or MDA using an enhanced flight vision system (EFVS) under IFR.|§91.176]] of this chapter and the certificate holder's operations specifications for EFVS operations.
...
\(3\) The certificate holder has an approved deicing/anti-icing program that complies with [[FAR-0121#§121.629   Operation in icing conditions.|§121.629]](c) of this chapter and the takeoff complies with that program.
...
Except as provided in [[FAR-0135#§135.3   Rules applicable to operations subject to this part.|§135.3]], this subpart prescribes the flight crewmember requirements for operations under this part.
...
\(1\) Of a turbojet airplane, of an airplane having a passenger-seat configuration, excluding each crewmember seat, of 10 seats or more, or of a multiengine airplane in a commuter operation as defined in [[FAR-0119|part 119 of this chapter]], unless that person holds an airline transport pilot certificate with appropriate category and class ratings and, if required, an appropriate type rating for that airplane.
...
\(a\) No certificate holder may use any person, nor may any person serve, as a pilot in command of an aircraft operated in a commuter operation, as defined in [[FAR-0119|part 119 of this chapter]] unless that person has completed, prior to designation as pilot in command, on that make and basic model aircraft and in that crewmember position, the following operating experience in each make and basic model of aircraft to be flown:
...
\(2\) Any other operation under this part, if the operator elects to comply with [[FAR-0135#§135.265   Flight time limitations and rest requirements: Scheduled operations.|§135.265]] and obtains an appropriate operations specification amendment.

\(c\) Sections 135.267 and 135.269 apply to any operation that is not a scheduled passenger-carrying operation and to any operation conducted solely within the State of Alaska, unless the operator elects to comply with [[FAR-0135#§135.265   Flight time limitations and rest requirements: Scheduled operations.|§135.265]] as authorized under paragraph (b)(2) of this section.
...
\(a\) A certificate holder may assign a flight crewmember and a flight crewmember may accept an assignment for flight time only when the applicable requirements of [[FAR-0135#§135.263   Flight time limitations and rest requirements: All certificate holders.|§§135.263]] through 135.271 are met.
...
\(ii\) A PIC who meets the applicable flight crewmember requirements of subpart E of part 135, except those prescribed in [[FAR-0135#§135.244   Operating experience.|§§135.244]] and 135.247; and

\(iii\) A second in command (SIC) who meets the SIC qualifications of [[FAR-0135#§135.245   Second in command qualifications.|§135.245]].

\(8\) For a four-pilot crew, at least three pilots who meet the conditions of paragraph (b)(7) of this section, plus a fourth pilot who meets the SIC qualifications of [[FAR-0135#§135.245   Second in command qualifications.|§135.245]].
...
Except as provided in [[FAR-0135#§135.3   Rules applicable to operations subject to this part.|§135.3]], this subpart—
...
\(d\) The instrument proficiency check required by [[FAR-0135#§135.297   Pilot in command: Instrument proficiency check requirements.|§135.297]] may be substituted for the competency check required by this section for the type of aircraft used in the check.
...
\(c\) The instrument proficiency check required by paragraph (a) of this section consists of an oral or written equipment test and a flight check under simulated or actual IFR conditions. The equipment test includes questions on emergency procedures, engine operation, fuel and lubrication systems, power settings, stall speeds, best engine-out speed, propeller and supercharger operations, and hydraulic, mechanical, and electrical systems, as appropriate. The flight check includes navigation by instruments, recovery from simulated emergencies, and standard instrument approaches involving navigational facilities which that pilot is to be authorized to use. Each pilot taking the instrument proficiency check must show that standard of competence required by [[FAR-0135#§135.293   Initial and recurrent pilot testing requirements.|§135.293]](e).

\(1\) The instrument proficiency check must—

\(i\) For a pilot in command of an airplane under [[FAR-0135#§135.243   Pilot in command qualifications.|§135.243]](a), include the procedures and maneuvers for an airline transport pilot certificate in the particular type of airplane, if appropriate; and

\(ii\) For a pilot in command of an airplane or helicopter under [[FAR-0135#§135.243   Pilot in command qualifications.|§135.243]](c), include the procedures and maneuvers for a commercial pilot certificate with an instrument rating and, if required, for the appropriate type rating.
...
\(c\) Each certificate holder shall establish in the manual required by [[FAR-0135#§135.21   Manual requirements.|§135.21]] a procedure which will ensure that each pilot who has not flown over a route and into an airport within the preceding 90 days will, before beginning the flight, become familiar with all available information required for the safe operation of that flight.
...
\(a\) Except as provided in [[FAR-0135#§135.3   Rules applicable to operations subject to this part.|§135.3]], this subpart prescribes the requirements applicable to—
...
\(7\) *Training center.* An organization governed by the applicable requirements of [[FAR-0142|part 142 of this chapter]] that conducts training, testing, and checking under contract or other arrangement to certificate holders subject to the requirements of this part.
...
\(i\) Recurrent pilot testing requirements of [[FAR-0135#§135.293   Initial and recurrent pilot testing requirements.|§135.293]];

\(ii\) Instrument proficiency check requirements of [[FAR-0135#§135.297   Pilot in command: Instrument proficiency check requirements.|§135.297]]; or

\(iii\) Line checks required by [[FAR-0135#§135.299   Pilot in command: Line checks: Routes and airports.|§135.299]].
...
\(a\) Each certificate holder required to have a training program under [[FAR-0135#§135.341   Pilot and flight attendant crewmember training programs.|§135.341]] shall:
...
\(a\) Other than the certificate holder, only another certificate holder certificated under this part or a training center certificated under [[FAR-0142|part 142 of this chapter]] is eligible under this subpart to conduct training, testing, and checking under contract or other arrangement to those persons subject to the requirements of this subpart.

\(b\) A certificate holder may contract with, or otherwise arrange to use the services of, a training center certificated under [[FAR-0142|part 142 of this chapter]] to conduct training, testing, and checking required by this part only if the training center—
...
\(4\) Has sufficient instructor and check airmen qualified under the applicable requirements of [[FAR-0135#§135.337   Qualifications: Check airmen (aircraft) and check airmen (simulator).|§§135.337]] through 135.340 to provide training, testing, and checking to persons subject to the requirements of this subpart.
...
\(2\) The initial and transition ground training in [[FAR-0135#§135.345   Pilots: Initial, transition, and upgrade ground training.|§§135.345]] and 135.349, as applicable.

\(3\) Emergency training in [[FAR-0135#§135.331   Crewmember emergency training.|§135.331]].

\(4\) Crew resource management training in [[FAR-0135#§135.330   Crew resource management training.|§135.330]].

\(b\) Each training program must provide the initial and transition flight training in [[FAR-0135#§135.347   Pilots: Initial, transition, upgrade, and differences flight training.|§135.347]], as applicable.

\(c\) Each training program must provide recurrent ground and flight training in [[FAR-0135#§135.351   Recurrent training.|§135.351]].

\(d\) Upgrade training in [[FAR-0135#§135.345   Pilots: Initial, transition, and upgrade ground training.|§§135.345]] and 135.347 for a particular type aircraft may be included in the training program for crewmembers who have qualified and served as second in command on that aircraft.
...
\(d\) In granting credit for initial CRM training, the Administrator considers training aids, devices, methods and procedures used by the certificate holder in a voluntary CRM program included in a training program required by [[FAR-0135#§135.341   Pilot and flight attendant crewmember training programs.|§135.341]], [[FAR-0135#§135.345   Pilots: Initial, transition, and upgrade ground training.|§135.345]], or [[FAR-0135#§135.349   Flight attendants: Initial and transition ground training.|§135.349]].
...
\(d\) In granting initial and final approval of training programs or revisions to them, the Administrator considers the training devices, methods and procedures listed in the certificate holder's curriculum under [[FAR-0135#§135.327   Training program: Curriculum.|§135.327]].
...
\(2\) Has at least 2 years of experience as a pilot in command in operations conducted under [[FAR-0091#§91.1053   Crewmember experience.|§91.1053]](a)(2)(i) of this chapter, [[FAR-0135#§135.243   Pilot in command qualifications.|§135.243]](a)(1) of this part, or as a pilot in command or second in command in any operation conducted under [[FAR-0121|part 121 of this chapter]];
...
\(a\) For the purposes of this section and [[FAR-0135#§135.339   Initial and transition training and checking: Check airmen (aircraft), check airmen (simulator).|§135.339]]:
...
\(3\) Check airmen (aircraft) and check airmen (simulator) are those check airmen who perform the functions described in [[FAR-0135#§135.321   Applicability and terms used.|§§135.321]] (a) and 135.323(a)(4) and (c).
...
\(4\) Has satisfactorily completed the applicable training requirements of [[FAR-0135#§135.339   Initial and transition training and checking: Check airmen (aircraft), check airmen (simulator).|§135.339]];
...
\(6\) Has satisfied the recency of experience requirements of [[FAR-0135#§135.247   Pilot qualifications: Recent experience.|§135.247]]; and
...
\(4\) Has satisfactorily completed the applicable training requirements of [[FAR-0135#§135.339   Initial and transition training and checking: Check airmen (aircraft), check airmen (simulator).|§135.339]]; and
...
\(a\) For the purposes of this section and [[FAR-0135#§135.340   Initial and transition training and checking: Flight instructors (aircraft), flight instructors (simulator).|§135.340]]:
...
\(3\) Flight instructors (aircraft) and flight instructors (simulator) are those instructors who perform the functions described in [[FAR-0135#§135.321   Applicability and terms used.|§135.321]](a) and 135.323 (a)(4) and (c).
...
\(4\) Has satisfactorily completed the applicable training requirements of [[FAR-0135#§135.340   Initial and transition training and checking: Flight instructors (aircraft), flight instructors (simulator).|§135.340]];

\(5\) Holds at least a Class III medical certificate; and

\(6\) Has satisfied the recency of experience requirements of [[FAR-0135#§135.247   Pilot qualifications: Recent experience.|§135.247]].
...
\(a\) Each certificate holder, other than one who uses only one pilot in the certificate holder's operations, shall establish and maintain an approved pilot training program, and each certificate holder who uses a flight attendant crewmember shall establish and maintain an approved flight attendant training program, that is appropriate to the operations to which each pilot and flight attendant is to be assigned, and will ensure that they are adequately trained to meet the applicable knowledge and practical testing requirements of [[FAR-0135#§135.293   Initial and recurrent pilot testing requirements.|§§135.293]] through 135.301. However, the Administrator may authorize a deviation from this section if the Administrator finds that, because of the limited size and scope of the operation, safety will allow a deviation from these requirements. This deviation authority does not extend to the training provided under [[FAR-0135#§135.336   Airline transport pilot certification training program.|§135.336]].
...
\(2\) Instruction as necessary in the subjects required for initial ground training by this subpart, as appropriate, including low-altitude windshear training and training on operating during ground icing conditions as prescribed in [[FAR-0135#§135.341   Pilot and flight attendant crewmember training programs.|§135.341]] and described in [[FAR-0135#§135.345   Pilots: Initial, transition, and upgrade ground training.|§135.345]], crew resource management training as prescribed in [[FAR-0135#§135.330   Crew resource management training.|§135.330]], and emergency training as prescribed in [[FAR-0135#§135.331   Crewmember emergency training.|§135.331]].

\(c\) Recurrent flight training for pilots must include, at least, flight training in the maneuvers or procedures in this subpart, except that satisfactory completion of the check required by [[FAR-0135#§135.293   Initial and recurrent pilot testing requirements.|§135.293]] within the preceding 12 calendar months may be substituted for recurrent flight training.
...
\(a\) This subpart prescribes airplane performance operating limitations applicable to the operation of the categories of airplanes listed in [[FAR-0135#§135.363   General.|§135.363]] when operated under this part.
...
\(a\) Each certificate holder operating a reciprocating engine powered large transport category airplane shall comply with [[FAR-0135#§135.365   Large transport category airplanes: Reciprocating engine powered: Weight limitations.|§§135.365]] through 135.377.

\(b\) Each certificate holder operating a turbine engine powered large transport category airplane shall comply with [[FAR-0135#§135.379   Large transport category airplanes: Turbine engine powered: Takeoff limitations.|§§135.379]] through 135.387, except that when it operates a turbopropeller-powered large transport category airplane certificated after August 29, 1959, but previously type certificated with the same number of reciprocating engines, it may comply with [[FAR-0135#§135.365   Large transport category airplanes: Reciprocating engine powered: Weight limitations.|§§135.365]] through 135.377.
...
\(d\) Each certificate holder operating a small transport category airplane shall comply with [[FAR-0135#§135.397   Small transport category airplane performance operating limitations.|§135.397]].

\(e\) Each certificate holder operating a small nontransport category airplane shall comply with [[FAR-0135#§135.399   Small nontransport category airplane performance operating limitations.|§135.399]].

\(f\) The performance data in the Airplane Flight Manual applies in determining compliance with [[FAR-0135#§135.365   Large transport category airplanes: Reciprocating engine powered: Weight limitations.|§§135.365]] through 135.387. Where conditions are different from those on which the performance data is based, compliance is determined by interpolation or by computing the effects of change in the specific variables, if the results of the interpolation or computations are substantially as accurate as the results of direct tests.
...
\(i\) The 10-mile width specified in [[FAR-0135#§135.369   Large transport category airplanes: Reciprocating engine powered: En route limitations: All engines operating.|§§135.369]] through 135.373 may be reduced to 5 miles, for not more than 20 miles, when operating under VFR or where navigation facilities furnish reliable and accurate identification of high ground and obstructions located outside of 5 miles, but within 10 miles, on each side of the intended track.

\(j\) Each certificate holder operating a commuter category airplane shall comply with [[FAR-0135#§135.398   Commuter category airplanes performance operating limitations.|§135.398]].
...
\(b\) In place of the requirements of paragraph (a) of this section, a person may, under an approved procedure, operate a reciprocating engine powered large transport category airplane at an all-engines-operating altitude that allows the airplane to continue, after an engine failure, to an alternate airport where a landing can be made under [[FAR-0135#§135.377   Large transport category airplanes: Reciprocating engine powered: Landing limitations: Alternate airports.|§135.377]], allowing for normal consumption of fuel and oil. After the assumed failure, the flight path must clear the ground and any obstruction within five miles on each side of the intended track by at least 2,000 feet.
...
\(1\) There is no place along the intended track that is more than 90 minutes (with all engines operating at cruising power) from an airport that meets [[FAR-0135#§135.377   Large transport category airplanes: Reciprocating engine powered: Landing limitations: Alternate airports.|§135.377]]; or
...
No person may list an airport as an alternate airport in a flight plan unless the airplane (at the weight anticipated at the time of arrival at the airport), based on the assumptions in [[FAR-0135#§135.375   Large transport category airplanes: Reciprocating engine powered: Landing limitations: Destination airports.|§135.375]](a) (1) and (2), can be brought to a full stop landing within 70 percent of the effective length of the runway.
...
\(1\) The accelerate-stop distance, as defined in [[FAR-0025#§25.109   Accelerate-stop distance.|§25.109]] of this chapter, must not exceed the length of the runway plus the length of any stopway.
...
\(2\) The net flight path allows the airplane to continue flight from the cruising altitude to an airport where a landing can be made under [[FAR-0135#§135.387   Large transport category airplanes: Turbine engine powered: Landing limitations: Alternate airports.|§135.387]] clearing all terrain and obstructions within five statute miles of the intended track by at least 2,000 feet vertically and with a positive slope at 1,000 feet above the airport where the airplane lands after an engine fails, or, if that airplane was certificated after September 30, 1958 (SR422A, 422B), with a positive slope at 1,500 feet above the airport where the airplane lands after an engine fails.
...
\(1\) There is no place along the intended track that is more than 90 minutes (with all engines operating at cruising power) from an airport that meets [[FAR-0135#§135.387   Large transport category airplanes: Turbine engine powered: Landing limitations: Alternate airports.|§135.387]].

\(2\) Its weight, according to the two-engine-inoperative, en route, net flight path data in the Airplane Flight Manual, allows the airplane to fly from the point where the two engines are assumed to fail simultaneously to an airport that meets [[FAR-0135#§135.387   Large transport category airplanes: Turbine engine powered: Landing limitations: Alternate airports.|§135.387]], with a net flight path (considering the ambient temperature anticipated along the track) having a positive slope at an altitude of at least 1,000 feet above all terrain and obstructions within five statute miles on each side of the intended track, or at an altitude of 5,000 feet, whichever is higher.
...
No person may select an airport as an alternate airport for a large nontransport category airplane unless that airplane (at the weight anticipated at the time of arrival), based on the assumptions in [[FAR-0135#§135.393   Large nontransport category airplanes: Landing limitations: Destination airports.|§135.393]](b), can be brought to a full stop landing within 70 percent of the effective length of the runway.

### §135.397   Small transport category airplane performance operating limitations.

\(a\) No person may operate a reciprocating engine powered small transport category airplane unless that person complies with the weight limitations in [[FAR-0135#§135.365   Large transport category airplanes: Reciprocating engine powered: Weight limitations.|§135.365]], the takeoff limitations in [[FAR-0135#§135.367   Large transport category airplanes: Reciprocating engine powered: Takeoff limitations.|§135.367]] (except paragraph (a)(3)), and the landing limitations in [[FAR-0135#§135.375   Large transport category airplanes: Reciprocating engine powered: Landing limitations: Destination airports.|§§135.375]] and 135.377.

\(b\) No person may operate a turbine engine powered small transport category airplane unless that person complies with the takeoff limitations in [[FAR-0135#§135.379   Large transport category airplanes: Turbine engine powered: Takeoff limitations.|§135.379]] (except paragraphs (d) and (f)) and the landing limitations in [[FAR-0135#§135.385   Large transport category airplanes: Turbine engine powered: Landing limitations: Destination airports.|§§135.385]] and 135.387.
...
\(c\) No person may operate a commuter category airplane unless that person complies with the landing limitations prescribed in [[FAR-0135#§135.385   Large transport category airplanes: Turbine engine powered: Landing limitations: Destination airports.|§§135.385]] and 135.387 of this part. For purposes of this paragraph, [[FAR-0135#§135.385   Large transport category airplanes: Turbine engine powered: Landing limitations: Destination airports.|§§135.385]] and 135.387 are applicable to all commuter category airplanes notwithstanding their stated applicability to turbine-engine-powered large transport category airplanes.
...
\(a\) No person may operate a reciprocating engine or turbopropeller-powered small airplane that is certificated under [[FAR-0135#§135.169   Additional airworthiness requirements.|§135.169]](b) (2), (3), (4), (5), or (6) unless that person complies with the takeoff weight limitations in the approved Airplane Flight Manual or equivalent for operations under this part, and, if the airplane is certificated under [[FAR-0135#§135.169   Additional airworthiness requirements.|§135.169]](b) (4) or (5) with the landing weight limitations in the Approved Airplane Flight Manual or equivalent for operations under this part.

\(b\) No person may operate an airplane that is certificated under [[FAR-0135#§135.169   Additional airworthiness requirements.|§135.169]](b)(6) unless that person complies with the landing limitations prescribed in [[FAR-0135#§135.385   Large transport category airplanes: Turbine engine powered: Landing limitations: Destination airports.|§§135.385]] and 135.387 of this part. For purposes of this paragraph, [[FAR-0135#§135.385   Large transport category airplanes: Turbine engine powered: Landing limitations: Destination airports.|§§135.385]] and 135.387 are applicable to reciprocating and turbopropeller-powered small airplanes notwithstanding their stated applicability to turbine engine powered large transport category airplanes.
...
\(1\) Aircraft that are type certificated for a passenger seating configuration, excluding any pilot seat, of nine seats or less, shall be maintained under parts 91 and 43 of this chapter and [[FAR-0135#§135.415   Service difficulty reports.|§§135.415]], 135.417, 135.421 and 135.422. An approved aircraft inspection program may be used under [[FAR-0135#§135.419   Approved aircraft inspection program.|§135.419]].

\(2\) Aircraft that are type certificated for a passenger seating configuration, excluding any pilot seat, of ten seats or more, shall be maintained under a maintenance program in [[FAR-0135#§135.415   Service difficulty reports.|§§135.415]], 135.417, 135.423 through 135.443.
...
\(c\) Single engine aircraft used in passenger-carrying IFR operations shall also be maintained in accordance with [[FAR-0135#§135.421   Additional maintenance requirements.|§135.421]] (c), (d), and (e).

\(d\) A certificate holder who elects to operate in accordance with [[FAR-0135#§135.364   Maximum flying time outside the United States.|§135.364]] must maintain its aircraft under paragraph (a)(2) of this section and the additional requirements of Appendix G of this part.
...
\(a\) Each interruption to a flight, unscheduled change of aircraft en route, or unscheduled stop or diversion from a route, caused by known or suspected mechanical difficulties or malfunctions that are not required to be reported under [[FAR-0135#§135.415   Service difficulty reports.|§135.415]].
...
\(a\) Whenever the Administrator finds that the aircraft inspections required or allowed under [[FAR-0091|part 91 of this chapter]] are not adequate to meet this part, or upon application by a certificate holder, the Administrator may amend the certificate holder's operations specifications under [[FAR-0119#§119.51   Amending operations specifications.|§119.51]], to require or allow an approved aircraft inspection program for any make and model aircraft of which the certificate holder has the exclusive use of at least one aircraft (as defined in [[FAR-0135#§135.25   Aircraft requirements.|§135.25]](b)).
...
\(e\) After approval, the certificate holder shall include the approved aircraft inspection program in the manual required by [[FAR-0135#§135.21   Manual requirements.|§135.21]].
...
\(b\) Each certificate holder that performs any inspections required by its manual under [[FAR-0135#§135.427   Manual requirements.|§135.427]](b) (2) or (3), (in this subpart referred to as *required inspections*), and each person with whom it arranges for the performance of that work, must have an organization adequate to perform that work.
...
\(f\) Each certificate holder who contracts for maintenance, preventive maintenance, or alterations must ensure that its system for the continuing analysis and surveillance of the maintenance, preventive maintenance, and alterations carried out by a maintenance provider, as required by [[FAR-0135#§135.431   Continuing analysis and surveillance.|§135.431]](a), contains procedures for oversight of all contracted covered work.

\(g\) The policies, procedures, methods, and instructions required by paragraphs (e) and (f) of this section must be acceptable to the FAA and included in the certificate holder's maintenance manual, as required by [[FAR-0135#§135.427   Manual requirements.|§135.427]](b)(10).
...
\(a\) Each certificate holder shall put in its manual the chart or description of the certificate holder's organization required by [[FAR-0135#§135.423   Maintenance, preventive maintenance, and alteration organization.|§135.423]] and a list of persons with whom it has arranged for the performance of any of its required inspections, other maintenance, preventive maintenance, or alterations, including a general description of that work.

\(b\) Each certificate holder shall put in its manual the programs required by [[FAR-0135#§135.425   Maintenance, preventive maintenance, and alteration programs.|§135.425]] that must be followed in performing maintenance, preventive maintenance, and alterations of that certificate holder's aircraft, including airframes, aircraft engines, propellers, rotors, appliances, emergency equipment, and parts, and must include at least the following:
...
\(a\) Each certificate holder shall keep (using the system specified in the manual required in [[FAR-0135#§135.427   Manual requirements.|§135.427]]) the following records for the periods specified in paragraph (b) of this section:

\(1\) All the records necessary to show that all requirements for the issuance of an airworthiness release under [[FAR-0135#§135.443   Airworthiness release or aircraft maintenance log entry.|§135.443]] have been met.
...
\(a\) The records specified in [[FAR-0135#§135.439   Maintenance recording requirements.|§135.439]](a)(2).

\(b\) The records specified in [[FAR-0135#§135.439   Maintenance recording requirements.|§135.439]](a)(1) which are not included in the records covered by paragraph (a) of this section, except that the purchaser may allow the seller to keep physical custody of such records. However, custody of records by the seller does not relieve the purchaser of its responsibility under [[FAR-0135#§135.439   Maintenance recording requirements.|§135.439]](c) to make the records available for inspection by the Administrator or any representative of the National Transportation Safety Board.
...
\(2\) Ensures that each person performing or directly supervising any of the job functions specified in [[FAR-0135#§135.501   Applicability and definitions.|§135.501]](a) is trained to comply with all applicable parts of 49 CFR parts 171 through 180 and the requirements of this subpart; and
...
\(b\) Each certificate holder must provide initial hazardous materials training and recurrent hazardous materials training to each crewmember and person performing or directly supervising any of the job functions specified in [[FAR-0135#§135.501   Applicability and definitions.|§135.501]](a).
...
\(d\) *New hire or new job function.* Each certificate holder using a person under the exception in [[FAR-0135#§135.505   Hazardous materials training required.|§135.505]](b) must maintain a record for that person. The records must be available upon request at the location where the trained person performs or directly supervises the job function specified in [[FAR-0135#§135.501   Applicability and definitions.|§135.501]](a). Records may be maintained electronically and provided on location electronically. The record must include the following:
...
\(5\) The date the person is to complete hazardous materials training in accordance with Appendix O of [[FAR-0121|part 121 of this chapter]].
...
\(c\) Certificate holders with HTAWS required by this section with an approved deviation under [[FAR-0021#§21.618   Approval for deviation.|§21.618]] of this chapter are in compliance with this section.
...
\(c\) Pilots conducting operations pursuant to this section may use the weather information obtained in paragraph (a) to satisfy the weather report and forecast requirements of [[FAR-0135#§135.213   Weather reports and forecasts.|§135.213]] and [[FAR-0135#§135.225   IFR: Takeoff, approach and landing minimums.|§135.225]](a).

\(d\) After completing a landing at the airport at which a weather report is not available, the pilot in command is authorized to determine if the weather meets the takeoff requirements of [[FAR-0097|part 97 of this chapter]] or the certificate holder's operations specification, as applicable.
...
\(4\) Participate in the preflight risk analysis required under [[FAR-0135#§135.617   Pre-flight risk analysis.|§135.617]] to include the following:
...
\(iii\) Pre-flight risk analysis procedures required under [[FAR-0135#§135.617   Pre-flight risk analysis.|§135.617]];
...
\(h\) *Drug and alcohol testing.* Operations control specialists must be tested for drugs and alcohol according to the certificate holder's Drug and Alcohol Testing Program administered under [[FAR-0120|part 120 of this chapter]].
...
\(1\) Passenger briefing requirements in [[FAR-0135#§135.117   Briefing of passengers before flight.|§135.117]](a) and (b); and
...
1\. *Applicability.* This appendix prescribes the additional airworthiness standards required by [[FAR-0135#§135.169   Additional airworthiness requirements.|§135.169]].
...
<table data-border="1" data-cellpadding="1" data-cellspacing="1" data-frame="void" width="100%"><tbody><tr class="header"><th scope="col">Parameters</th><th scope="col">Range</th><th scope="col">Installed system<sup>1</sup> minimum accuracy (to recovered data)</th><th scope="col">Sampling interval (per second)</th><th scope="col">Resolution<sup>3</sup> read out</th></tr><tr class="odd"><td style="text-align: left;" scope="row">Relative time (from recorded on prior to takeoff)</td><td style="text-align: left;">25 hr minimum</td><td style="text-align: left;">±0.125% per hour</td><td style="text-align: left;">1</td><td style="text-align: left;">1 sec.</td></tr><tr class="even"><td style="text-align: left;" scope="row">Indicated airspeed</td><td style="text-align: left;">V<span>m</span> in to V<span>D</span> (KIAS) (minimum airspeed signal attainable with installed pilot-static system)</td><td style="text-align: left;">±5% or ±10 kts., whichever is greater</td><td style="text-align: left;">1</td><td style="text-align: left;">1 kt.</td></tr><tr class="odd"><td style="text-align: left;" scope="row">Altitude</td><td style="text-align: left;">−1,000 ft. to 20,000 ft. pressure altitude</td><td style="text-align: left;">±100 to ±700 ft. (see Table 1, TSO C51-a)</td><td style="text-align: left;">1</td><td style="text-align: left;">25 to 150 ft.</td></tr><tr class="even"><td style="text-align: left;" scope="row">Magnetic heading</td><td style="text-align: left;">360°</td><td style="text-align: left;">±5°</td><td style="text-align: left;">1</td><td style="text-align: left;">1°.</td></tr><tr class="odd"><td style="text-align: left;" scope="row">Vertical acceleration</td><td style="text-align: left;">−3g to + 6g</td><td style="text-align: left;">±0.2g in addition to ±0.3g maximum datum</td><td style="text-align: left;">4 (or 1 per second where peaks, ref. to 1g are recorded)</td><td style="text-align: left;">0.05g.</td></tr><tr class="even"><td style="text-align: left;" scope="row">Longitudinal acceleration</td><td style="text-align: left;">±1.0g</td><td style="text-align: left;">±1.5% max. range excluding datum error of ±5%</td><td style="text-align: left;">2</td><td style="text-align: left;">0.03g.</td></tr><tr class="odd"><td style="text-align: left;" scope="row">Pitch attitude</td><td style="text-align: left;">100% of usable range</td><td style="text-align: left;">±2°</td><td style="text-align: left;">1</td><td style="text-align: left;">0.8°.</td></tr><tr class="even"><td style="text-align: left;" scope="row">Roll attitude</td><td style="text-align: left;">±60° or 100% of usable range, whichever is greater</td><td style="text-align: left;">±2°</td><td style="text-align: left;">1</td><td style="text-align: left;">0.8°.</td></tr><tr class="odd"><td style="text-align: left;" scope="row">Altitude rate</td><td style="text-align: left;">±8,000 fpm</td><td style="text-align: left;">±10% Resolution 250 fpm below 12,000 ft. indicated</td><td style="text-align: left;">1</td><td style="text-align: left;">250 fpm below 12,000.</td></tr><tr class="even"><td style="text-align: center;" scope="row">Engine Power, Each Engine</td><td style="text-align: left;"></td><td style="text-align: left;"></td><td style="text-align: left;"></td><td style="text-align: left;"></td></tr><tr class="odd"><td style="text-align: left;" scope="row">Main rotor speed</td><td style="text-align: left;">Maximum range</td><td style="text-align: left;">±5%</td><td style="text-align: left;">1</td><td style="text-align: left;">1%<sup>2</sup></td></tr><tr class="even"><td style="text-align: left;" scope="row">Free or power turbine</td><td style="text-align: left;">Maximum range</td><td style="text-align: left;">+ 5%</td><td style="text-align: left;">1</td><td style="text-align: left;">1%<sup>2</sup></td></tr><tr class="odd"><td style="text-align: left;" scope="row">Engine torque</td><td style="text-align: left;">Maximum range</td><td style="text-align: left;">±5%</td><td style="text-align: left;">1</td><td style="text-align: left;">1%<sup>2</sup></td></tr><tr class="even"><td style="text-align: center;" scope="row">Flight Control—Hydraulic Pressure</td><td style="text-align: left;"></td><td style="text-align: left;"></td><td style="text-align: left;"></td><td style="text-align: left;"></td></tr><tr class="odd"><td style="text-align: left;" scope="row">Primary (discrete)</td><td style="text-align: left;">High/low</td><td style="text-align: left;"></td><td style="text-align: left;">1</td><td style="text-align: left;"></td></tr><tr class="even"><td style="text-align: left;" scope="row">Secondary—if applicable (discrete)</td><td style="text-align: left;">High/low</td><td style="text-align: left;"></td><td style="text-align: left;">1</td><td style="text-align: left;"></td></tr><tr class="odd"><td style="text-align: left;" scope="row">Radio transmitter keying (discrete)</td><td style="text-align: left;">On/off</td><td style="text-align: left;"></td><td style="text-align: left;">1</td><td style="text-align: left;"></td></tr><tr class="even"><td style="text-align: left;" scope="row">Autopilot engaged (discrete)</td><td style="text-align: left;">Engaged or disengaged</td><td style="text-align: left;"></td><td style="text-align: left;">1</td><td style="text-align: left;"></td></tr><tr class="odd"><td style="text-align: left;" scope="row">SAS status—engaged (discrete)</td><td style="text-align: left;">Engaged/disengaged</td><td style="text-align: left;"></td><td style="text-align: left;">1</td><td style="text-align: left;"></td></tr><tr class="even"><td style="text-align: left;" scope="row">SAS fault status (discrete)</td><td style="text-align: left;">Fault/OK</td><td style="text-align: left;"></td><td style="text-align: left;">1</td><td style="text-align: left;"></td></tr><tr class="odd"><td style="text-align: center;" scope="row">Flight Controls</td><td style="text-align: left;"></td><td style="text-align: left;"></td><td style="text-align: left;"></td><td style="text-align: left;"></td></tr><tr class="even"><td style="text-align: left;" scope="row">Collective<sup>4</sup></td><td style="text-align: left;">Full range</td><td style="text-align: left;">±3%</td><td style="text-align: left;">2</td><td style="text-align: left;">1%<sup>2</sup></td></tr><tr class="odd"><td style="text-align: left;" scope="row">Pedal Position<sup>4</sup></td><td style="text-align: left;">Full range</td><td style="text-align: left;">±3%</td><td style="text-align: left;">2</td><td style="text-align: left;">1%<sup>2</sup></td></tr><tr class="even"><td style="text-align: left;" scope="row">Lat. Cyclic<sup>4</sup></td><td style="text-align: left;">Full range</td><td style="text-align: left;">±3%</td><td style="text-align: left;">2</td><td style="text-align: left;">1%<sup>2</sup></td></tr><tr class="odd"><td style="text-align: left;" scope="row">Long. Cyclic<sup>4</sup></td><td style="text-align: left;">Full range</td><td style="text-align: left;">±3%</td><td style="text-align: left;">2</td><td style="text-align: left;">1%<sup>2</sup></td></tr><tr class="even"><td style="text-align: left;" scope="row">Controllable Stabilator Position<sup>4</sup></td><td style="text-align: left;">Full range</td><td style="text-align: left;">±3%</td><td style="text-align: left;">2</td><td style="text-align: left;">1%<sup>2</sup></td></tr></tbody></table>
...
G135.1.1   *Adequate Airport* means an airport that an airplane operator may list with approval from the FAA because that airport meets the landing limitations of [[FAR-0135#§135.385   Large transport category airplanes: Turbine engine powered: Landing limitations: Destination airports.|§135.385]] or is a military airport that is active and operational.
...
\(c\) The operation is planned to be no more than 240 minutes flying time (at the one engine inoperative cruise speed under standard conditions in still air) from an airport described in [[FAR-0135#§135.364   Maximum flying time outside the United States.|§135.364]]; and
...
G135.2.3   *Airplane requirements.* No certificate holder may conduct ETOPS in an airplane that was manufactured after February 17, 2015 unless the airplane meets the standards of [[FAR-0025#§25.1535   ETOPS approval.|§25.1535]].

G135.2.4   *Crew information requirements.* The certificate holder must ensure that flight crews have in-flight access to current weather and operational information needed to comply with [[FAR-0135#§135.83   Operating information required.|§135.83]], [[FAR-0135#§135.225   IFR: Takeoff, approach and landing minimums.|§135.225]], and [[FAR-0135#§135.229   Airport requirements.|§135.229]]. This includes information on all ETOPS Alternate Airports, all destination alternates, and the destination airport proposed for each ETOPS flight.
...
\(i\) Fuel sufficient to fly to an ETOPS Alternate Airport assuming a rapid decompression at the most critical point followed by descent to a safe altitude in compliance with the oxygen supply requirements of [[FAR-0135#§135.157   Oxygen equipment requirements.|§135.157]];

\(ii\) Fuel sufficient to fly to an ETOPS Alternate Airport (at the one-engine-inoperative cruise speed under standard conditions in still air) assuming a rapid decompression and a simultaneous engine failure at the most critical point followed by descent to a safe altitude in compliance with the oxygen requirements of [[FAR-0135#§135.157   Oxygen equipment requirements.|§135.157]]; or
...
\(B\) When certifying the completion of the ETOPS PDSC outside of the U.S. holds a certificate in accordance with [[FAR-0043#§43.17   Maintenance, preventive maintenance, and alterations performed on U.S. aeronautical products by certain Canadian persons.|§43.17]](c)(1) of this chapter; or
...
\(C\) Entity authorized pursuant to [[FAR-0043#§43.17   Maintenance, preventive maintenance, and alterations performed on U.S. aeronautical products by certain Canadian persons.|§43.17]](c)(2) of this chapter.
...
\(h\) *Enhanced Continuing Analysis and Surveillance System (E-CASS) program.* A certificate holder's existing CASS must be enhanced to include all elements of the ETOPS maintenance program. In addition to the reporting requirements of [[FAR-0135#§135.415   Service difficulty reports.|§135.415]] and [[FAR-0135#§135.417   Mechanical interruption summary report.|§135.417]], the program includes reporting procedures, in the form specified in [[FAR-0135#§135.415   Service difficulty reports.|§135.415]](e), for the following significant events detrimental to ETOPS within 96 hours of the occurrence to the responsible Flight Standards office:
