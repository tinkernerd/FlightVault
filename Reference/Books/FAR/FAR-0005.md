...
\(a\) A certificate holder under [[FAR-0119|part 119 of this chapter]] authorized to conduct operations in accordance with the requirements of [[FAR-0121|part 121 of this chapter]] must have a Safety Management System that meets the requirements of this part and is acceptable to the Administrator by March 9, 2018.
...
\(6\) An emergency response plan that provides for the safe transition from normal to emergency operations in accordance with the requirements of [[FAR-0005#§5.27   Coordination of emergency response planning.|§5.27]].

\(b\) The safety policy must be signed by the accountable executive described in [[FAR-0005#§5.25   Designation and responsibilities of required safety management personnel.|§5.25]].
...
\(1\) Accountable executive, as described in [[FAR-0005#§5.25   Designation and responsibilities of required safety management personnel.|§5.25]].
...
\(5\) Regularly review the safety performance of the certificate holder's organization and direct actions necessary to address substandard safety performance in accordance with [[FAR-0005#§5.75   Continuous improvement.|§5.75]].
...
\(a\) When applying safety risk management, the certificate holder must analyze the systems identified in [[FAR-0005#§5.51   Applicability.|§5.51]]. Those system analyses must be used to identify hazards under paragraph (c) of this section, and in developing and implementing risk controls related to the system under [[FAR-0005#§5.55   Safety risk assessment and control.|§5.55]](c).
...
\(a\) The certificate holder must develop and maintain processes to analyze safety risk associated with the hazards identified in [[FAR-0005#§5.53   System analysis and hazard identification.|§5.53]](c).
...
\(3\) Evaluate the effectiveness of the safety risk controls established under [[FAR-0005#§5.55   Safety risk assessment and control.|§5.55]](c) and identify any ineffective controls.
...
The certificate holder must establish and implement processes to correct safety performance deficiencies identified in the assessments conducted under [[FAR-0005#§5.73   Safety performance assessment.|§5.73]].

## Subpart E—Safety Promotion

### §5.91   Competencies and training.

The certificate holder must provide training to each individual identified in [[FAR-0005#§5.23   Safety accountability and authority.|§5.23]] to ensure the individuals attain and maintain the competencies necessary to perform their duties relevant to the operation and performance of the SMS.
...
\(c\) The certificate holder must maintain a record of all training provided under [[FAR-0005#§5.91   Competencies and training.|§5.91]] for each individual. Such records must be retained for as long as the individual is employed by the certificate holder.

\(d\) The certificate holder must retain records of all communications provided under [[FAR-0005#§5.93   Safety communication.|§5.93]] for a minimum of 24 consecutive calendar months.
